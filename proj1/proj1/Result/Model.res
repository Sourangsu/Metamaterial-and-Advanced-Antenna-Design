...
lifetime=s:persistent
result=s:0
treepath=s:1D Results\Materials\Spleen\Dispersive\Eps' (Fit)
files=s:Spleen_eps_re.sig
xlabel=s:Frequency / GHz
title=s:Electric Dispersion: Nth Order Model, N=4 (Fit)
...
lifetime=s:persistent
result=s:0
treepath=s:1D Results\Materials\Spleen\Dispersive\Eps' (Data list)
files=s:Spleen_eps_mre_list.sig
xlabel=s:Frequency / GHz
title=s:Electric Dispersion: Nth Order Model, N=4 (Fit)
...
result=s:0
treepath=s:1D Results\Materials\Spleen\Dispersive\Eps'' (Data list)
files=s:Spleen_eps_mim_list.sig
xlabel=s:Frequency / GHz
title=s:Electric Dispersion: Nth Order Model, N=4 (Fit)
...
lifetime=s:persistent
result=s:0
treepath=s:1D Results\Materials\Water (sea)\Dispersive\Eps'
files=s:Water (sea)_eps_re.sig
xlabel=s:Frequency / GHz
...
lifetime=s:persistent
result=s:0
treepath=s:1D Results\Materials\Water (sea)\Dispersive\Eps TangD
files=s:Water (sea)_eps_tgd.sig
xlabel=s:Frequency / GHz
title=s:Electric Dispersion: Conductivity Model
